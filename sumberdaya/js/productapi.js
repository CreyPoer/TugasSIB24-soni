var endpointUrl = "https://crudcrud.com/api/7a7e0f1c2bf04a9080f7f66d25ef7b96/wisata";
                ...
                <div class="isicontent">
                    ...
                    <div class="deskripsiisicontent">
                        ...
                        <div class="tomboldetail">
                            ...
                            <div class="tomboldetail2">
                                <button type="button" id="tomboledit" onclick="editWisata(endpointUrl,'${element._id}','${element.nama_wisata}','${element.linkgambar}','${element.htm}','${element.deskripsi}')"><b>Edit Wisata</b></button>
                                <button class="button" id="tombolhapus" onclick="hapusWisata(endpointUrl,'${element._id}')"><b>Hapus Wisata</b></button>
                            </div>
                    </div>
                </div>
